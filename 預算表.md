...
sheet.style.maxWidth = '1200px';
sheet.style.height = '80%';
sheet.style.overflow = 'auto';
sheet.style.border = '0 1px 1px 1px solid #ddd';
sheet.style.borderRadius = '8px';
sheet.style.padding = '20px 20px 20px 20px';
...
const thead = document.createElement('thead');
  ...
  thead.style.boxShadow = '0 4px 20px rgba(0,0,0,0.3)';
...
tbody.style.boxShadow = '0 4px 20px rgba(0,0,0,0.3)';
...
tfoot.style.borderRadius = '8px';
tfoot.style.boxShadow = '0 4px 20px rgba(0,0,0,0.3)';
tfoot.style.marginBottom = '20px';
