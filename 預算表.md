  ...
  if (data && typeof data === 'object' && !Array.isArray(data)) {
    ...
    Object.keys(data).forEach(key => {
      ...
      if (!currentMonthName || currentMonthName === '') {
        ...
        isCurrentMonth = true;
        console.log('[預算表] 沒有月份名稱，處理所有符合類型的資料');
      } else {
        // 檢查 key 是否包含當前月份名稱
      ...
      console.log('[預算表] key', key, 'isCurrentMonth =', isCurrentMonth, 'currentMonthName =', currentMonthName);
      if (!isCurrentMonth) {
...
const loadContentFromMemory = () => {
  ...
  // 處理資料（會自動過濾並顯示記錄）
  if (monthData.data) {
    console.log('[預算表] loadContentFromMemory: 開始處理資料，monthData.data type =', typeof monthData.data, 'isArray =', Array.isArray(monthData.data));
...
const loadContent = async (forceReload = false) => {
  ...
  try {
    ...
    // 處理資料（會自動過濾並顯示記錄）
    if (monthData.data) {
      console.log('[預算表] loadContent: 開始處理資料，monthData.data type =', typeof monthData.data, 'isArray =', Array.isArray(monthData.data));
      processDataFromResponse(monthData.data, true);
