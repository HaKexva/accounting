...
totalContainer.style.height = '40vh';
totalContainer.style.minHeight = '200px';
totalContainer.style.margin = '20px 0 0 0';
...
document.addEventListener('DOMContentLoaded', async function() {
  ...
  incomeColumn.style.textAlign = 'center';
  
  const incomeTitle = document.createElement('h3');
  incomeTitle.textContent = '收入：';
  incomeTitle.style.margin = '0 0 10px 0';
  ...
  expenseColumn.style.textAlign = 'center';
  
  const expenseTitle = document.createElement('h3');
  expenseTitle.textContent = '支出：';
  expenseTitle.style.margin = '0 0 10px 0';
  ...
  totalColumn.style.textAlign = 'center';
  
  const totalTitle = document.createElement('h3');
  totalTitle.textContent = '總計：';
  totalTitle.style.margin = '0 0 10px 0';
  ...
  chartContainer.style.border = '2px dashed #ccc';
  ...
  chartContainer.textContent = '圓形圖位置(待實現)';

  totalContainer.appendChild(columnsContainer);
  totalContainer.appendChild(chartContainer);
