...
totalContainer.style.width = '90%';
totalContainer.style.maxWidth = '400px';
totalContainer.style.height = '40vh';
totalContainer.style.minHeight = '200px';
totalContainer.style.margin = '0 auto';
totalContainer.style.padding = '20px';
totalContainer.style.position = 'fixed';
totalContainer.style.top = '50%';
totalContainer.style.left = '50%';
totalContainer.style.transform = 'translate(-50%, -50%)';
